export default {
  ...
  people: [
    ['Hong Sen Du', 'hongsendude'],
    'Mike Fu',
    'Natalie Guerra',
    ['Stephanie Lai', 'stephaniealai'],
    ['Charlotte Li (pictured in the favicon)', 'shallotly'],
    ['Jason Kao (who pictured Charlotte in the favicon)', 'jsonkao'],
    ['Jessica Li', 'heyjessicali'],
    'Ivana Moore',
    'Seyla Phan',
    'Kelly Pu',
    ['Raeedah Wahid', 'raeedahwahid'],
    'Eve Washington',
    ['Jun Yi Zhang', 'jenny_jyzhang'],
  ],
};
